/*
 ...
 Clock with NTP and a 7-segment display
...
void setup()
{
  ...
  matrix.begin(0x70);
  matrix.write(10000); // clearing it
...
long int getTime()
{
  ...
  if (!cb) {
    ...
    // Unix time starts on Jan 1 1970 while NTP starts in 1900
    // thus subtract seventy years:
